...
import { TournamentLogo, ArtBackground } from './PlayoffArt';
...
export default function PlayoffPoster({ tournament, matches, cup: selectedCup, instagramAll = false }) {
  ...
  if (instagramAll || selectedCup) return <InstagramDesign tournament={tournament} matches={matches} cup={selectedCup} all={instagramAll} />;
