...
createRoot(document.getElementById('root')).render(mode === 'tv' ? <TvPlayer entries={entries} date='2026-09-26' seconds={120} /> : <div style={{ maxWidth: 750, margin: 'auto' }}>{mode === 'plata' || mode === 'all' ? <PlayoffPoster tournament={tournament} matches={matches} cup={mode === 'plata' ? 'plata' : undefined} instagramAll={mode === 'all'} /> : <PlayoffImage tournament={tournament} matches={matches} />}</div>);
